...
<form id="article-form"
  ...
  <div class="mb-3">
    ...
    {{-- Textarea editor TANPA name 'content' dan TANPA required --}}
    <textarea id="editor" class="form-control" rows="12">{{ old('content', $article->content) }}</textarea>
...
@push('scripts')
  ...
  <script>
    ...
    // Sinkronisasi konten ke hidden input saat submit
