  ...
  <form class="row g-2 mb-3" method="GET" action="{{ route('admin.discussions.index') }}">
    <div class="col-sm-8 col-md-6">
      <input
        ...
        name="q"
        class="form-control"
        placeholder="Cari diskusi (judul/isi)…"
    ...
    @foreach($discussions as $d)
      <div class="mb-4 p-3 border rounded">
        <div class="d-flex justify-content-between align-items-start">
          ...
          <form method="POST" action="{{ route('admin.discussions.destroy', $d) }}" onsubmit="return confirm('Hapus diskusi?')">
            @csrf @method('DELETE')
        ...
        {{-- Balasan --}}
        <div class="mb-2">
          <strong>Balasan ({{ $d->replies->count() }}):</strong>
        </div>
