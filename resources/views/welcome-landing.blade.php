...
<section class="mb-4">
  ...
  <div class="accordion" id="faqMini">
    ...
    <div class="accordion-item">
      ...
      <div id="a1" class="accordion-collapse collapse" aria-labelledby="q1" data-bs-parent="#faqMini">
    ...
    <div class="accordion-item">
      ...
      <div id="a2" class="accordion-collapse collapse" aria-labelledby="q2" data-bs-parent="#faqMini">
        <div class="accordion-body">
          Waktu bervariasi tergantung lokasi & tingkat prioritas. Pantau progresnya di menu <em>Cek Laporan</em>.
        </div>
      </div>
    </div>
    ...
    <div class="accordion-item">
      ...
      <div id="a3" class="accordion-collapse collapse" aria-labelledby="q3" data-bs-parent="#faqMini">
        <div class="accordion-body">
          Foto jelas area penumpukan (maks 2MB), sebaiknya terlihat konteks sekitar agar memudahkan verifikasi.
        </div>
      </div>
    </div>
    ...
    <div class="accordion-item">
      ...
      <div id="a4" class="accordion-collapse collapse" aria-labelledby="q4" data-bs-parent="#faqMini">
        <div class="accordion-body">
          Melihat artikel & TPA/TPS bisa tanpa login. Untuk Diskusi & Pelaporan, Anda perlu login dahulu.
        </div>
      </div>
    </div>
    ...
    <div class="accordion-item">
      ...
      <div id="a5" class="accordion-collapse collapse" aria-labelledby="q5" data-bs-parent="#faqMini">
        <div class="accordion-body">
          Masuk ke akun Anda lalu buka menu <strong>Cek Laporan</strong>. Di sana terlihat status & riwayat tindak lanjut.
        </div>
      </div>
    </div>
    ...
    <div class="accordion-item">
      <h2 class="accordion-header" id="q6">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#a6" aria-expanded="false" aria-controls="a6">
          Bisakah laporan diubah atau dibatalkan?
        </button>
      </h2>
      <div id="a6" class="accordion-collapse collapse" aria-labelledby="q6" data-bs-parent="#faqMini">
        <div class="accordion-body">
          Selama belum diproses, Anda bisa menghubungi admin melalui halaman laporan atau kontak untuk pembaruan/penarikan.
        </div>
      </div>
    </div>
  </div>
